...
var FormRegisterComponent = /** @class */ (function () {
    function FormRegisterComponent(Builder) {
        var _this = this;
        this.Builder = Builder;
        this.formSubmit = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.resetForm = function () {
            _this.formData = _this.Builder.group({
                first_name: ['John', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                last_name: ['Doee', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                email: ['john@doe.com', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                password: ['azerty123', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                password_repeate: ['azerty123', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                street: ['21, boulevard de la République', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                city: ['Lol sur seine', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                country: ['France', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                birthdate: ['01/01/1970', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                ...
                zip_code: ['95500', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
